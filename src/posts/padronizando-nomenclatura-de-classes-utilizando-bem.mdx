...
Blocos podem ser definidos como componentes que são maiores e/ou reutilizáveis na sua aplicação. Pense nesses elementos como sendo o pai, uma vez que que os Elementos e os Modificadores estarão dentro deles. Por exemplo: menu, cabeçalho, card, rodapé, etc…
...
Quer aprender desenvolvimento frontend? Por apenas 20,00 reais o [eFront](https://www.iuricode.com/efront/) vai te ajudar.

O [eFront](https://www.iuricode.com/efront/) é uma coleção de materiais escritos (_ebooks_) onde é ensinado **HTML, CSS, JavaScript, Sass, React, TypeScript, styled-components e Tailwind CSS**.

![Banner do eFront](/efront.png)

Mais de **2.000 pessoas já compraram**, você vem comigo?

👉 **[Acessar o link da venda](https://www.iuricode.com/efront/)**
