...
Blocos podem ser definidos como componentes que são maiores e/ou reutilizáveis na sua aplicação. Pense nesses elementos como sendo o pai, uma vez que que os Elementos e os Modificadores estarão dentro deles. Por exemplo: menu, cabeçalho, rodapé, etc…

## O que é Elemento?

Elementos são filhos dos Blocos. Vale ressaltar que um Elemento só pode ter apenas um pai. Por exemplo: item de menu, título do cabeçalho, redes sociais do rodapé, etc…
...
Por exemplo, se você tem um Bloco .menu, um Elemento dele pode ser .menu**item ou .menu**link.
...
Sua regra de escrita é uma classe composta pelo nome de um Bloco ou Modificador + dois hífens + o nome do Modificador: [Bloco|Elemento]--[Modificador].

Seguindo o exemplo, poderia haver um modificador para o menu .menu--dark para um versão escura; uma versão do menu fixa com .menu--fixed ou; para links desabilitados, .menu\_\_link--disabled.
